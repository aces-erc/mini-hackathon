...
const AddCustomer = () => {
  ...
  <form onSubmit={addCustomer} class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div class="mb-6">
      ...
      <input onChange={(e)=>setCustomerData({...customerData, phone: e.target.value})} class="appearance-none  rounded w-full  py-2 px-3 text-gray-700  leading-tight focus:outline-none focus:shadow-outline" id="phone" type="number" placeholder="Customer's Phone" />
      </div>
    </div>
